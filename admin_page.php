...
<body>
   ...
   <h2 style="text-align: center;"><b>--1. Want to see previously enlisted items?</b>
      <br><br>
      <a href="items_enlisted.php"><button type="button" class="btn btn-outline-danger" style="margin-left:20px ;"><b>Click here!</b></button></a>
   </h2>
   <br><br><hr><br><br>
   <h2 style="text-align: center;"><b>--2. Want to enlist new items?</b>
      <br><br>
      <a href="itemstoenlist.php"><button type="button" class="btn btn-outline-danger" style="margin-left:20px ;"><b>Click here!</b></button></a>  
   </h2>
